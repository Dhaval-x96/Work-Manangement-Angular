...
import { CanDeactiveService } from './common/guards/can-deactive.service';
...
const routes: Routes = [
  ...
  { path: 'dashboard', component: DashboardComponent, canActivate: [AuthGuard] },
  {
    path: 'work', component: WorkComponent, canActivate: [AuthGuard], children: [
      { path: 'addWork', component: AddworkComponent, canDeactivate: [CanDeactiveService], canActivateChild: [AuthGuard] },
  ...
  },
  {
    path: 'worker', component: WorkerComponent, canActivate: [AuthGuard], children: [
      { path: 'addWorker', component: AddworkerComponent, canDeactivate: [CanDeactiveService], canActivateChild: [AuthGuard] },

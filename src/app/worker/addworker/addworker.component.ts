...
import { ICanDeactive } from '../../common/guards/can-deactive.service';
...
export class AddworkerComponent implements OnInit, ICanDeactive {
  ...
  canDeactive(): Observable<boolean> | Promise<boolean> | boolean {
    ...
    if (this.workerForm.touched && this.workerForm.dirty && this.workerForm.invalid) {
      return confirm("Do you want to Discard the data ?")
    } else {
      return true;
    }
